...
context("Actions", () => {
  ...
  describe("Home Page", () => {
    it(".click() - Link to Next.js Course", () => {
      cy.get('[data-testid="nextjs-course-link"]').should("be.visible");
      cy.get('[data-testid="nextjs-course-link"]').focus();
      cy.focused().should("have.attr", "data-testid", "nextjs-course-link");
      cy.get('[data-testid="nextjs-course-link"]').contains(
  ...
  describe("Login Page", () => {
    it(".type() - type into a DOM element", () => {
      ...
      cy.get("[name='email']").type("{del}{selectall}{backspace}");

      // .type() with key modifiers
      cy.get("[name='email']").type("{alt}{option}"); //these are equivalent
      cy.get("[name='email']").type("{ctrl}{control}"); //these are equivalent
      cy.get("[name='email']").type("{meta}{command}{cmd}"); //these are equivalent
      cy.get("[name='email']").type("{shift}");

      // Delay each keypress by 0.1 sec
      cy.get("[name='email']").type("slow.typing@email.com", { delay: 100 });
      cy.get("[name='email']").should("have.value", "slow.typing@email.com");
    });
  });
  /*
