...
export const createUnixSeconds = createBrand<number, typeof UNIX_SECONDS_BRAND>(
  UNIX_SECONDS_BRAND,
);

export const createDurationSeconds = createBrand<
  number,
  typeof DURATION_SECONDS_BRAND
>(DURATION_SECONDS_BRAND);

export const createTimeDeltaSeconds = createBrand<
  number,
  typeof TIME_DELTA_SECONDS_BRAND
