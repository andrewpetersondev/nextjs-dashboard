...
/**
 * @file seeds/best-seed-test-db.ts
 ...
 *
 * Quick start:
 *   POSTGRES_URL_TESTDB=postgres://... pnpm ts-node src/db/seeds/best-seed-test-db.ts
 *   SEED_RESET=true pnpm ts-node src/db/seeds/best-seed-test-db.ts # force re-seed (TRUNCATE)
 */
