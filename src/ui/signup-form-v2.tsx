    ...
    <>
      ...
      */}
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        {/* Container for signup form, social signup, and link to log in page*/}
            ...
            <form action={action} className="space-y-6">
              ...
              <div>
                ...
                <div className="@container mt-2 flex items-center">
                  ...
                  />
                  <UserIcon className="pointer-events-none ml-2 h-[18px] w-[18px] text-gray-500 peer-focus:text-gray-900" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="@container mt-2 flex items-center">
                  <input
                    ...
                    className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  />
                  <AtSymbolIcon className="pointer-events-none ml-2 h-[18px] w-[18px] peer-focus:text-gray-900" />
                </div>
              </div>
              {state?.errors?.email && (
