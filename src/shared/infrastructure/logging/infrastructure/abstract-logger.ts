...
import { isPublicProd } from "@/shared/infrastructure/config/env-public";
import type { LogLevel } from "@/shared/infrastructure/config/env-schemas";
import { getProcessId } from "@/shared/infrastructure/config/env-utils";
import type { LogEntry } from "@/shared/infrastructure/logging/core/logger.types";
import {
  consoleMethod,
  currentLogLevelPriority,
  logLevelPriority,
} from "@/shared/infrastructure/logging/infrastructure/logging.levels";
import { toSafeErrorShape } from "@/shared/infrastructure/logging/infrastructure/logging.mappers";
import { createRedactor } from "@/shared/infrastructure/logging/redaction/redaction";
