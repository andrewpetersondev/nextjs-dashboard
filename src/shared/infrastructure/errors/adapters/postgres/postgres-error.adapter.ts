import { mapPgError } from "@/shared/infrastructure/errors/adapters/postgres/postgres-code.translator";
import type { DatabaseOperationMetadata } from "@/shared/infrastructure/errors/adapters/postgres/postgres-error.types";
import type { AppError } from "@/shared/infrastructure/errors/core/app-error.class";
import type { ErrorMetadata } from "@/shared/infrastructure/errors/core/error.types";
import {
  makeAppError,
  makeDatabaseError,
} from "@/shared/infrastructure/errors/factories/app-error.factory";
