import { isDev } from "@/shared/infrastructure/config/env-shared";
import type {
  AppErrorJson,
  AppErrorOptions,
  ErrorMetadata,
...
import {
  type AppErrorKey,
  getAppErrorCodeMeta,
} from "@/shared/infrastructure/errors/registries/error-code.registry";
import {
...
} from "@/shared/infrastructure/errors/utils/serialization.utils";
