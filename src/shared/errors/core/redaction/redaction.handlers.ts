import { CIRCULAR_REF_PLACEHOLDER } from "@/shared/errors/core/redaction/redaction.constants";
import type {
  ArrayRedactOptions,
  InternalConfig,
  ObjectRedactOptions,
} from "@/shared/errors/core/redaction/redaction.types";
import {
  applyMask,
  isSensitiveKey,
} from "@/shared/errors/core/redaction/redaction.utils";
