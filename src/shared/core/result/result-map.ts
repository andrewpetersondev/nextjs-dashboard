 ...
 *
 * Branch semantics: On Ok, applies fn to data and returns Ok(mapped). On Err, returns the same Err unchanged.
 *
 ...
 *
 * Branch semantics: On Err, applies fn to error and returns Err(mapped). On Ok, returns the same Ok unchanged.
 *
 ...
 *
 * Branch semantics: On Ok, applies onOk to data and returns Ok(mapped). On Err, applies onErr to error and returns Err(mapped).
 *
