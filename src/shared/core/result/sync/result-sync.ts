 ...
 * @typeParam TError - The type of error to return, extending `ErrorLike`.
 ...
 */
export const fromNullable = <TValue, TError extends ErrorLike>(
 ...
 */
export const fromPredicate = <TValue, TError extends ErrorLike>(
  value: TValue,
