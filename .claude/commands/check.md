---
description: Full validation — Biome + Markdown + typegen + typecheck + migration drift + unit/integration + e2e (report-only)
allowed-tools: Bash(pnpm check)
disallowed-tools: Edit, Write, NotebookEdit
---

Run `pnpm check`. This is the **full** gate — it runs the unit + integration lanes and the Cypress e2e
